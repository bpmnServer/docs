...
- [loopDefinition](BusinessRuleTask.md#loopdefinition)
...
[elements/Tasks.ts:119](https://github.com/bpmnServer/bpmn-server/blob/67a073b/src/elements/Tasks.ts#L119)
